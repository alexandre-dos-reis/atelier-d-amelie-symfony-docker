...
class VisitorRepository extends ServiceEntityRepository
{
    ...
    public function findUniqueVisitors(): int
    {
        $qb = $this->createQueryBuilder('v')->select('count(distinct v.ip) as uniqueVisitors');
        return $qb->getQuery()->execute()[0]['uniqueVisitors'];
    }

    public function FindVisitorEntrance()
    {

    }

    public function FindVisitorExit()
    {
