 ...
 */
final class Version20220413161845 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Adding designState and Watermarked image to ImageProduct Entity';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE image_product ADD image_watermarked VARCHAR(255) DEFAULT NULL, ADD design_state LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', CHANGE file image_original VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_product ADD file VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP image_original, DROP image_watermarked, DROP design_state');
