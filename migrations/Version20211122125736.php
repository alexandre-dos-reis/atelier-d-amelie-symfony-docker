 ...
 */
final class Version20211122125736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6117D13B6BF700BD ON purchase');
        $this->addSql('ALTER TABLE purchase ADD status VARCHAR(20) NOT NULL, DROP status_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase ADD status_id INT DEFAULT NULL, DROP status');
