 ...
 */
final class Version20220411130407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork CHANGE filepath_full image_original VARCHAR(255) NOT NULL, CHANGE image_editor_json design_state LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_product CHANGE file file VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
