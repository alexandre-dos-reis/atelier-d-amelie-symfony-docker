 ...
 */
final class Version20220411070249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork ADD image_editor_json LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', ADD image_watermarked VARCHAR(255) DEFAULT NULL');
    }
